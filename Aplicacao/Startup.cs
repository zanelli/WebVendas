    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<Repositorio.Contexto.ApplicationDbContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("WebVendas")));

            // Injeta o HttpContextAccessor para trabalhar com sessão, usando o padraõ singleton 
            //services.AddSingleton<IHttpContextAccessor, HttpContextAccessor>();
            services.AddHttpContextAccessor(); // ^^ Removido pois todas instâncias do sistema estavam no singleton
            // Para utilizar sessão
            services.AddSession();
